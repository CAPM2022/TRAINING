...
const drUtils = require('./dynamic-routing-utils');
const cookie = require('cookie');

module.exports.getRequestCredentials = getRequestCredentials;
...
function getRequestCredentials(req) {
  ...
  let source = cookies && cookies.locationAfterLogin ? {url: cookies.locationAfterLogin} : req;
  let appKey = drUtils.getApplicationKey(source);
  return appKey && appKey.appPrefix ? module.exports.getCredentials(appKey.appPrefix, true, req) : null;
}